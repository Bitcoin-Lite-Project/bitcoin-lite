...
###   This script attempts to download the signature file SHA256SUMS.asc from bitcoinlite.org
...
WORKINGDIR="/tmp/bitcoinlite"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://bitcoinlite.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://bitcoinlite.org/bin/"
VERSIONPREFIX="bitcoinlite-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'bitcoinlite-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitcoinlite-]<version>-[rc[0-9]] (example: bitcoinlite-0.9.2-rc1)"
   echo "wget output:"
