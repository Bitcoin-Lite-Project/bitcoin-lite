The following is a list of assets used in the bitcoinlite source and their proper attribution.
...
* License: MIT
* Site: [https://bitcoinlitetalk.org/index.php?topic=15276.0](https://bitcoinlitetalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinlite logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/bitcoinlite.icns, src/qt/res/src/bitcoinlite.svg,
	src/qt/res/src/bitcoinlite.ico, src/qt/res/src/bitcoinlite.png,
	src/qt/res/src/bitcoinlite_testnet.png, docs/bitcoinlite_logo_doxygen.png,
