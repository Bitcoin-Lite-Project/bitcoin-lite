...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CBitcoinLiteAddress demoAddress = CBitcoinLiteAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CBitcoinLiteAddress setaccountDemoAddress = CBitcoinLiteAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CBitcoinLiteAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcoinLiteAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
