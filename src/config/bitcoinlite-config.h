/* src/config/bitcoinlite-config.h.  Generated from bitcoinlite-config.h.in by configure.  */
/* src/config/bitcoinlite-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCOINLITE_CONFIG_H

#define BITCOINLITE_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@bitcoinlite.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinLite Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinLite Core 0.10.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinlite"
