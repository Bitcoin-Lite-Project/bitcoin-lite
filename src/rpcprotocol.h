...
#ifndef BITCOINLITE_RPCPROTOCOL_H
#define BITCOINLITE_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! BitcoinLite is not connected
...
#endif // BITCOINLITE_RPCPROTOCOL_H
