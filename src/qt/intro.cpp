...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitcoinlite"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinLite Core"),
     ...
     * override -datadir in the bitcoinlite.conf file in the default data directory
     * (to be consistent with bitcoinlited behavior)
     */
    if(dataDir != getDefaultDataDirectory())
