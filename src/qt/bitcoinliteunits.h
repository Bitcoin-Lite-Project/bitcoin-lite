...
#ifndef BITCOINLITE_QT_BITCOINLITEUNITS_H
#define BITCOINLITE_QT_BITCOINLITEUNITS_H
...
/** BitcoinLite unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinLiteUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinLiteUnits(QObject *parent);

    /** BitcoinLite units.
      @note Source: https://en.bitcoinlite.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BCL,
...
typedef BitcoinLiteUnits::Unit BitcoinLiteUnit;

#endif // BITCOINLITE_QT_BITCOINLITEUNITS_H
