...
unlocked to sign the BitcoinLite-Qt.app bundle.
...
allowing somebody to distribute a BitcoinLite-Qt.app or bitcoinlite-qt-setup.exe with a valid
...
that the bitcoinlite-qt.exe file inside the installer had not been tampered with.
