...
from test_framework import BitcoinLiteTestFramework
...
class TxnMallTest(BitcoinLiteTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BCL:
        ...
        # First: use raw transaction API to send 1210 BCL to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50BCL for another
        ...
        # Node0's total balance should be starting balance, plus 100BCL for 
